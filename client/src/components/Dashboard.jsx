  ...
  return (
    <div className='w-full h-auto flex flex-col items-center justify-center bg-primary'>
      ...
      <div className='w-[60%] my-2 p-4 flex items-center justify-evenly'>
        <NavLink to={"/dashboard/home"} className={({ isActive }) => (isActive ? isActiveStyles : isNotActiveStyles)}><IoHome className='text-2xl text-textColor' />
        </NavLink>

        <NavLink to={"/dashboard/users"} id="dashBoardUser" className={({ isActive }) => (isActive ? isActiveStyles : isNotActiveStyles)}>Users</NavLink>
